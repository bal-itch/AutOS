...

{
  ...
  fileSystems."/" =
    { device = "/dev/disk/by-uuid/673524fd-5c9b-4ed1-be71-c13210e43b9a";
      fsType = "ext4";
    };

  fileSystems."/boot" =
    { device = "/dev/disk/by-uuid/9AAC-A294";
      fsType = "vfat";
    };

  swapDevices =
    [ { device = "/dev/disk/by-uuid/65e696ea-e5b5-43a9-b08f-746f481905eb"; }
    ];
